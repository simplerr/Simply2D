...
static const std::string TP_ENTER =							"misc\\textures\\tp_enter.bmp";
static const std::string TP_DEST =							"misc\\textures\\tp_exit.bmp";
...
static const std::string GATE_SOURCE =						"misc\\textures\\gate.bmp";
static const std::string TURRET_LASER_SOURCE =				"misc\\textures\\turret_laser.bmp";
