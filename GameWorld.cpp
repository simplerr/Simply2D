...
void GameWorld::createLevel(void)
{
	...
	MovingPlatform *movingPlatform = new MovingPlatform(100, 400, 100, 100, "brick_platform.bmp", start, end, mPlayer);
	addDynamicObject(movingPlatform);
	start.x = 100;
	start.y = 200;
	end.x = 600;
	end.y = 200;
	MovingPlatform *movingPlatform1 = new MovingPlatform(100, 200, 100, 100, "grass_platform.bmp", start, end, mPlayer, HORIZONTAL, 0.04f);
