		...
		else
		{
			...
			if(itemToCreate != "none")
			{
				...
				{					
					...
					{
						StaticPlatform *platform = new StaticPlatform(500, 300, 100, 100, "brick_platform.bmp");
						mLevel->addStaticObject(platform);
					}
					else if(itemToCreate == "Grass Platform")
					{
						StaticPlatform *platform = new StaticPlatform(500, 300, 100, 100, "grass_platform.bmp");
						mLevel->addStaticObject(platform);
					}
